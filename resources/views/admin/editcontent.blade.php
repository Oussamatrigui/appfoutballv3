                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-success">
                           ...
                           @endif
                            ...
                            <!-- form start -->
                            {!! Form::open([
                                'action' => 'App\Http\Controllers\ContentController@updatecontent',
                                'method' => 'POST',
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    {{ Form::text('titre_article', $content->titre_article, ['class' => 'form-control', 'id' => 'exempleInputEmail1', 'placeholder' => 'Entrer titre']) }}
                                </div>
                                <div class="form-group">
                                    ...
                                    {{ Form::textarea('article', $content->article, ['class' => 'form-control', 'id' => 'exempleInputEmail1', 'placeholder' => 'Entrer ']) }}
                                </div>
                                <div class="form-group">
                                    ...
                                    {{ Form::text('nom_auteur', $content->nom_auteur, ['class' => 'form-control', 'id' => 'exempleInputEmail1', 'placeholder' => 'Entrer nom']) }}
                                </div>
                               {{-- <div class="form-group">
