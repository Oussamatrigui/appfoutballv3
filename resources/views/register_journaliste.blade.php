...
<main class="register-form ftco-animate">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-4">
                <div class="card">
                    <h3 class="card-header text-center">Register Journaliste </h3>
                    @if (count($errors) > 0 )
                    ...
                    <div class="card-body">
                        ...
                        @endif
                            ...
                            <form class="action" action="{{url('/journalist-register')}}" method="POST">
                                ...
                                <div class="form-group mb-3">
                                    <a class="col-md-7 col-form-label text-md-right" href="{{ url('backoffice') }}">
