...
@section('content')
    ...
    <div class="hero-wrap hero-bread" style="background-image: url('images/panier.jpg');">
        <div class="container">
                                ...
                                @if (Session::has('cart'))
                                    @foreach ($products as $product)
                                        <tr class="text-center">
                                            ...
                                            <form
                                                action="{{ url('/modifier_quant/' . $product['product_id']) }} "method="POST">
                                                {{ csrf_field() }}
                                                <td class="quantity">
            ...
            <div class="row justify-content-end">
               {{-- <div class="col-lg-4 mt-5 cart-wrap ftco-animate">
                ...
                <div class="col-lg-4 mt-5 cart-wrap ftco-animate">
                    ...
                    <p><a href="{{ url('/paiement') }}" class="btn btn-primary py-3 px-4">Passer à la caisse</a></p>
                </div>
            </div>
        </div>
    </section>
