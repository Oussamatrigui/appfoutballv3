              ...
              {{--<form id="quickForm">--}}
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    {{Form::text('product_name','', ['class' => 'form-control', 'id' => 'exempleInputEmail1', 'placeholder' =>'Entrer product'])}}
                  </div>
                  <div class="form-group">
                    ...
                    {{Form::text('product_price','', ['class' => 'form-control', 'id' => 'exempleInputEmail1', 'placeholder' =>'Entrer product price'])}}
                  </div>
                  <div class="form-group">
