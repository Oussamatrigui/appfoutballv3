              ...
              {{--<form >--}}
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    {{Form::text('description1','', ['class' => 'form-control', 'id' => 'exempleInputEmail1', 'placeholder' =>'Entrer description one'])}}
                  </div>
                  <div class="form-group">
                    ...
                    {{Form::text('description2','', ['class' => 'form-control', 'id' => 'exempleInputEmail1', 'placeholder' =>'Entrer description two'])}}
                  </div>
